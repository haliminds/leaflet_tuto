...
function initialize()
{
	...
	let map = L.map("map").setView([40.90296, 1.90925], 2);

	const stamen = L.tileLayer('https://stamen-tiles-{s}.a.ssl.fastly.net/toner/{z}/{x}/{y}.{ext}', {
	...
	const heatLayer = L.heatLayer(heatMapData, {maxZoom: 12});
