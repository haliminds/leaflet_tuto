function initialize() {
  ...
  map = L.map('map').setView([45.18, 5.740], 13);
	...
	osm = new L.TileLayerZoomSwitch_v2(osmUrl,{minZoom:8, maxZoom:18, switchZoomStart: 13, switchZoomEnd: 13, attribution:osmAttrib}); // 13
	testmade = new L.TileLayerZoomSwitch_v2(cmUrl, {maxZoom:15, attribution: cmAttrib, switchZoomStart: 14, switchZoomEnd: 15} );      // 14 to 15
